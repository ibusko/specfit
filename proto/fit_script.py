...
def print_output(x, fit_result, compound_model, mask, chisq_in, chisq_out, n_free_par, start_time, end_time):
...
def process_dir(datadir, datafile, regionsfile, modelfile):
    ...
    print_output(x, fit_result, compound_model, mask, chisq_in, chisq_out, n_free_par, start_time, end_time)


if __name__ == "__main__":

#    process_dir("../data/n5548/", "n5548_mean_g130mb4.asc", "n5548_lyalpha_sample.dat", "sfn5548_lyalpha2")

    process_dir("../data/simple/", "obs1g.dat", None, "obs1g_model.dat")
