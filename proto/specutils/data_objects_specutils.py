# For convenience, his file is being duplicated in here
# from the 'specview.SView' project. It remains to be
# seen if we are going to use the same data import
# solution, or something entirely different?
